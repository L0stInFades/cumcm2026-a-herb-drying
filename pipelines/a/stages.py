...
Stage map: q1, q2, q3, q4, convergence, verification, sensitivity (pipelines/a/science.py); derived (derived.py);
...
from pipelines.a import derived, extension, figures, outputs, science  # noqa: F401 - registers the stages on import
