...
\begin{enumerate}[label=(\alph*),leftmargin=*]
  ...
  \item \textbf{\nolinkurl{result2.xlsx} 的时间范围}：问题 2 要求“整个烘干过程”的模型，但在“完整结果”前未像问题 1 那样写出时间上限。本文按与表 3、表 4 一致的 \SI{3}{\hour} 每 \SI{1}{\second} 交付 \nolinkurl{result2.xlsx}，并\textbf{另行交付} \nolinkurl{result2\_全过程.xlsx}（同一模板、温度与水分浓度两张表、覆盖 $0$--$t_{\mathrm{end}}$、分辨率 \SI{60}{\second}），使两种读法都有对应的交付物（第~\ref{subsec:q2range} 小节）。
\end{enumerate}
